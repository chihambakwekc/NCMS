...
class Command(BaseCommand):
    help = "Create or update one real NCMS system administrator profile. No demo data is created."
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f"{action} NCMS system administrator: {username}"))
